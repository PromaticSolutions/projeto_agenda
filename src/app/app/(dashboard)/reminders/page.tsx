...
export default async function RemindersPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {/* O disparo real depende da Evolution API, que ainda não está integrada.
          Dizer isso na tela evita que o dono ligue os lembretes e fique
          esperando um envio que não vai acontecer. */}
